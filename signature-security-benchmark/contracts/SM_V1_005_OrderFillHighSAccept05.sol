...
contract SM_SM_V1_005_Verifier {
...
contract SM_OrderFillHighSAccept05 {
    ...
    SM_SM_V1_005_Verifier public immutable verifier;
    mapping(bytes32 => uint256) public executedAt;
    uint256 public calls;
    constructor(address signer_, SM_SM_V1_005_Verifier verifier_) { authorizedSigner = signer_; verifier = verifier_; }
