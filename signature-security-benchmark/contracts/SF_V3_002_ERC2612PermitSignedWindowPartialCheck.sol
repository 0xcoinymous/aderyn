...
contract SF_ERC2612PermitSignedWindowPartialCheck002 {
    ...
    function execute(address owner, address spender, uint256 value, uint256 validAfter, uint256 validBefore, bytes calldata signature) external payable {
        ...
        bytes32 digest = keccak256(abi.encode(owner, spender, value, nonce, address(this), block.chainid, validAfter, validBefore));
