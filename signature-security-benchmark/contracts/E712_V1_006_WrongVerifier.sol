...
contract E712_WrongVerifier {
    ...
    address public immutable domainVerifier;
    ...
    constructor(address router) { domainVerifier=router; }
    function _domain() internal view returns(bytes32) { return E712_BenchLib.domain("WrongVerifier","1",domainVerifier); }
