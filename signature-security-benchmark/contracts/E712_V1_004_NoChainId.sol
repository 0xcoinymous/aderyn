...
contract E712_NoChainId {
    ...
    bytes32 private constant DTYPE = keccak256("EIP712Domain(string name,string version,address verifyingContract)");
    function _domain() internal view returns(bytes32) { return keccak256(abi.encode(DTYPE,keccak256(bytes("MultiChainApp")),keccak256(bytes("1")),address(this))); }
