...
contract E712_WrongUintType {
    ...
    bytes32 private constant TYPEHASH = keccak256("Action(address signer,address recipient,uint128 amount,bytes32 actionId,bytes32 authId)");
