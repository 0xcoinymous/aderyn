...
contract E712_NoVerifyingContract {
    ...
    bytes32 private constant DTYPE = keccak256("EIP712Domain(string name,string version,uint256 chainId)");
    function _domain() internal view returns(bytes32) { return keccak256(abi.encode(DTYPE,keccak256(bytes("SharedApp")),keccak256(bytes("1")),block.chainid)); }
