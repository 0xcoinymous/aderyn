...
contract NM_SwapQuoteSafeUnordered02 {
    ...
    function swapBySig(address signer, address recipient, uint256 amount, bytes32 actionId, uint256 nonce, uint8 v, bytes32 r, bytes32 s) external  {
