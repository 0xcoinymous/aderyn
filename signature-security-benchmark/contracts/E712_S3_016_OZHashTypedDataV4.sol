...
contract E712_OZHashTypedDataV4 {
    ...
    function _domainSeparatorV4() internal view returns(bytes32){return E712_BenchLib.domain("OZFinal","1",address(this));} function _hashTypedDataV4(bytes32 h) internal view returns(bytes32){return keccak256(abi.encodePacked("\x19\x01",_domainSeparatorV4(),h));}
