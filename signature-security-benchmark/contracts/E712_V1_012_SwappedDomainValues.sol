...
contract E712_SwappedDomainValues {
    ...
    function _domain() internal view returns(bytes32) { return keccak256(abi.encode(DTYPE,keccak256(bytes("SwapOrder")),keccak256(bytes("1")),address(this),block.chainid)); }
