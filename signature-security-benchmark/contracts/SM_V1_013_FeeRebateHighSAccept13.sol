...
contract SM_SM_V1_013_Verifier {
...
contract SM_FeeRebateHighSAccept13 {
    ...
    SM_SM_V1_013_Verifier public immutable verifier;
    mapping(bytes32 => uint256) public executedAt;
    uint256 public calls;
    constructor(address signer_, SM_SM_V1_013_Verifier verifier_) { authorizedSigner = signer_; verifier = verifier_; }
