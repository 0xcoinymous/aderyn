...
contract E712_RawNameInDomain {
    ...
    function _domain() internal view returns(bytes32) { string memory n="RawName"; return keccak256(abi.encode(DTYPE,n,keccak256(bytes("1")),block.chainid,address(this))); }
