...
contract SF_RFQOrderSafeSignedValidityWindowHelper005 {
    ...
    function execute(address maker, address taker, uint128 baseAmount, uint128 quoteAmount, bytes32 quoteId, uint256 validAfter, uint256 validBefore, bytes calldata signature) external payable {
        ...
        bytes32 digest = keccak256(abi.encode(maker, taker, baseAmount, quoteAmount, quoteId, nonce, address(this), block.chainid, validAfter, validBefore));
