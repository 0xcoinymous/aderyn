...
contract E712_WrongFieldName {
    ...
    bytes32 private constant TYPEHASH = keccak256("Action(address signer,address beneficiary,uint256 amount,bytes32 actionId,bytes32 authId)");
