...
contract E712_FixedChainId {
    ...
    function _domain() internal view returns(bytes32) { return keccak256(abi.encode(DTYPE,keccak256(bytes("FixedChain")),keccak256(bytes("1")),uint256(1),address(this))); }
