...
contract E712_MissingVersionType {
    ...
    bytes32 private constant DTYPE = keccak256("EIP712Domain(string name,uint256 chainId,address verifyingContract)");
    function _domain() internal view returns(bytes32) { return keccak256(abi.encode(DTYPE,keccak256(bytes("Mismatch")),keccak256(bytes("1")),block.chainid,address(this))); }
