...
abstract contract E712_Base_006 { function _typed(bytes32 d,bytes32 s) internal pure returns(bytes32){return keccak256(abi.encodePacked("\x19\x01",d,s));} }

contract E712_InheritedHashTyped is E712_Base_006 {
    ...
    function execute(address signer, address recipient, address token, address target, uint256 amount, bytes32 actionId, bytes32 authId, bytes calldata callData, uint8 v, bytes32 r, bytes32 s) external {
        ...
        bytes32 digest=_typed(domainSeparator,structHash);
