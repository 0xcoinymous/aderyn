...
contract SF_SessionAuthorizationSignedDeadlineNotChecked034 {
    ...
    function execute(address account, address sessionKey, uint256 limit, uint256 deadline, bytes calldata signature) external payable {
        ...
        bytes32 digest = keccak256(abi.encode(account, sessionKey, limit, nonce, address(this), block.chainid, deadline));
