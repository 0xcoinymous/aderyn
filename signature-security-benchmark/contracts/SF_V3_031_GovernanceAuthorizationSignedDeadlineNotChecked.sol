...
contract SF_GovernanceAuthorizationSignedDeadlineNotChecked031 {
    ...
    function execute(address delegator, uint256 proposalId, uint8 choice, uint256 deadline, bytes calldata signature) external payable {
        ...
        bytes32 digest = keccak256(abi.encode(delegator, proposalId, choice, nonce, address(this), block.chainid, deadline));
