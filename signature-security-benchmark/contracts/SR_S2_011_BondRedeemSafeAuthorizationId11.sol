...
contract SR_BondRedeemSafeAuthorizationId11 is SR_ReplayBenchSignerBase {
    mapping(address => uint256) public bondRedeemed;
    mapping(bytes32 => uint8) public authorizationState;
    ...
    function redeemBond(address holder, uint256 amount, bytes32 bondId, bytes32 authorizationId, bytes calldata signature) external {
        require(authorizationState[authorizationId] == 0, "used");
        ...
        authorizationState[authorizationId] = 1;
