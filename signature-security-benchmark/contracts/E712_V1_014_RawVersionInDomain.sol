...
contract E712_RawVersionInDomain {
    ...
    function _domain() internal view returns(bytes32) { string memory ver="1"; return keccak256(abi.encode(DTYPE,keccak256(bytes("RawVersion")),ver,block.chainid,address(this))); }
