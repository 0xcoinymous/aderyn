...
contract E712_CachedDynamicDomain {
    ...
    uint256 private immutable cachedChain; bytes32 private immutable cachedDomain; constructor(){cachedChain=block.chainid;cachedDomain=E712_BenchLib.domain("CacheSafe","1",address(this));} function _domain() internal view returns(bytes32){return block.chainid==cachedChain?cachedDomain:E712_BenchLib.domain("CacheSafe","1",address(this));}
