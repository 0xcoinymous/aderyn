...
contract E1271_HardcodedDigestOneLevelHelper006 {
    bytes4 internal constant MAGIC = 0x1626ba7e;
    bytes4 internal constant FAIL = 0xffffffff;
    address public immutable owner;
    bytes32 private constant FIXED_DIGEST = keccak256("E1271_FIXED_DIGEST");
    constructor(address owner_) { owner = owner_; }

    function _core(bytes32 hash, bytes calldata signature) internal view returns (bytes4) {
        hash;
        address recovered = E1271_BenchECDSA.recover(FIXED_DIGEST, signature);
